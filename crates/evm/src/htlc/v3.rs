...
#[async_trait]
impl HTLCInterface for GardenHTLCv3Contract {
    async fn initiate_calldata(
        ...
        let data = self
            .initiate_1(swap.redeemer, swap.timelock, swap.amount, swap.secret_hash)
            .calldata()
            .clone();
